...
public class FieldConstants {
    ...
    public static final Pose2d leftStartBlue = new Pose2d(
            LinesVertical.allianceZone - 0.26162,
            LinesHorizontal.leftBumpEnd + LeftBump.width / 2, new Rotation2d());

    public static final Pose2d centerStartBlue = new Pose2d(
            LinesVertical.allianceZone - 0.26162,
            LinesHorizontal.center, new Rotation2d());

    public static final Pose2d rightStartBlue = new Pose2d(
            LinesVertical.allianceZone - 0.26162,
            LinesHorizontal.rightBumpStart - RightBump.width / 2, new Rotation2d());

    public static final Pose2d leftStartRed = new Pose2d(
            LinesVertical.oppAllianceZone + 0.26162,
            LinesHorizontal.leftBumpEnd + LeftBump.width / 2, new Rotation2d(Math.toRadians(180)));

    public static final Pose2d centerStartRed = new Pose2d(
            LinesVertical.oppAllianceZone + 0.26162,
            LinesHorizontal.center, new Rotation2d(Math.toRadians(180)));

    public static final Pose2d rightStartRed = new Pose2d(
            LinesVertical.oppAllianceZone + 0.26162,
            LinesHorizontal.rightBumpStart - RightBump.width / 2, new Rotation2d(Math.toRadians(180)));
